...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(django.db.models.expressions.F('user_id'), django.db.models.expressions.F('following_user_id'), name='unique follower/following'),
        ),
    ]
